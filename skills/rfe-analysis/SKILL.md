...
**EB-2 Eligibility (prerequisite):** Before analyzing the NIW waiver, the petitioner must qualify as EB-2 via advanced degree (master's or higher, or bachelor's + 5 years progressive experience) OR exceptional ability (meeting 3 of 6 criteria under 8 CFR 204.5(k)(3)(ii)). USCIS sometimes challenges EB-2 eligibility itself. Common challenge: foreign degree equivalency not clearly established, or "bachelor's + experience" pathway not adequately documented with progressive responsibility.
...
- Common RFE language: "The evidence does not establish that the proposed endeavor has national importance" or "The documentation shows local impact but does not demonstrate national scope."
- Industry applicants: tie to federal priorities (DOE, NIH, DHS strategic plans, executive orders, national competitiveness). The challenge is usually proving your work benefits the nation, not just your employer.
- Academic applicants: national importance is usually easier to establish through research impact. Focus on broader societal implications beyond the university.
...
- Common RFE language: "The record does not establish a track record of success with similar efforts" or "The evidence focuses on past achievements but does not establish how the beneficiary will advance the endeavor going forward."
- Industry applicants: show specific projects, revenue impact, adoption metrics, system scale — not just job title and years of experience. Concrete deliverables matter more than credentials.
- Academic applicants: this is often the main challenge. Show funding pipeline (grants received or applied for), publication trajectory, lab resources, collaborator network, concrete research plan with milestones.
...
- Common RFE language: "The evidence does not establish that, on balance, it would be beneficial to the United States to waive the requirements" or "The petitioner has not shown why a labor market test would be inappropriate."
- CRITICAL PATTERN — "already employed" push-back: USCIS frequently argues that the petitioner already holds a position in the field, so the labor certification process would not be an impediment. This is the most common prong 3 challenge for industry applicants. Addressing it requires showing: (1) the work transcends any single employer, (2) the labor certification process would be impractical for the specific endeavor, or (3) the petitioner offers contributions that go beyond what the general labor pool provides.
- Industry applicants: "already employed" is the primary challenge. Must show work is not tied to one employer and that PERM would be impractical or counterproductive to the national interest.
- Academic applicants: prong 3 is about showing the research agenda would be impaired by tying to one employer via PERM. Easier if the research has cross-institutional implications or requires flexibility to follow funding/collaboration opportunities.
